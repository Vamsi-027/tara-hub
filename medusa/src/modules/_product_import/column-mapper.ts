...
export class ColumnMapper {
  private static readonly EXPECTED_FIELDS = new Map([
    ...
    ['uom', { required: false, dataType: 'string', aliases: ['unit', 'unit_of_measure', 'measure_unit'] }],
    ['min_increment', { required: false, dataType: 'number', aliases: ['min_inc', 'increment', 'step_size'] }],
    ['min_cut', { required: false, dataType: 'number', aliases: ['minimum_cut', 'min_order_qty'] }],
    ['reorder_point', { required: false, dataType: 'number', aliases: ['rop', 'reorder_level'] }],
    ['safety_stock', { required: false, dataType: 'number', aliases: ['buffer_stock', 'safety_level'] }],
    ['low_stock_threshold', { required: false, dataType: 'number', aliases: ['low_stock', 'low_level'] }],
    ['backorder_policy', { required: false, dataType: 'string', aliases: ['backorder_mode', 'backorders'] }],
