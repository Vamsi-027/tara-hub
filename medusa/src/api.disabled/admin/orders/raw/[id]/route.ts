/**
 * Raw Order API Route
 * Bypasses Medusa v2 serialization issues by querying database directly
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  try {
    ...
    console.log(`🔍 Raw order query for: ${orderId}`)

    // Skip authentication for this raw endpoint to ensure it works
    // This is safe because we're only reading order data
