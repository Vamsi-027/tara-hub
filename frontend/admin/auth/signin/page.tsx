    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600">Premium Fabric Marketplace Admin</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-gradient-to-br from-blue-50 to-indigo-100 px-2 text-gray-500">Or continue with</span>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <CardDescription className="text-center mt-3 text-xs">
              Google OAuth for existing authorized accounts
            </CardDescription>
          </CardContent>
        </Card>
