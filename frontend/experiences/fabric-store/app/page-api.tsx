...
import { useFabrics, useFabricCollections } from '../hooks/useFabrics'
import {
  MenuIcon,
  XIcon,
  SearchIcon,
...
// Featured Collections - Now using API
function FeaturedCollections() {
  const { collections, loading, error } = useFabricCollections()
...
// Popular Swatches Preview - Now using API
function PopularSwatches() {
  const { fabrics, loading } = useFabrics({ limit: 8 })
...
// Site Header Component (unchanged)
function SiteHeader() {
  return (
...
// Main Page
export default function FabricSwatchesHomepageWithAPI() {
